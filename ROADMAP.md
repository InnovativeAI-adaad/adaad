...
## What ships today — v9.44.0

Phase 109 (INNOV-24 SVP) shipped v9.42.0. Phase 110 (INNOV-25 HAF) shipped v9.43.0. Phase 111 (INNOV-26 CEB) shipped v9.44.0. ADAAD now enforces constitutional entropy budgets — rate-limiting genesis drift and requiring double-HUMAN-0 at 30% threshold. 113 Hard-class invariants enforced. Innovations INNOV-01 through INNOV-26 are shipped across v9.18.0–v9.44.0 (Phases 87–111), with deterministic evidence artifacts recorded per phase closure.

**Current/Next:** Current = **Phase 111** (`v9.44.0`, INNOV-26 CEB shipped). Next = **Phase 112 — INNOV-27 Mutation Blast Radius Modeling**.
