...
![Version: 3.8.0](https://img.shields.io/badge/Version-3.8.0-2ea043)
![Phase: 13 Complete](https://img.shields.io/badge/Phase-13%20Complete-6366f1)
![Tests: 2545+ Passing](https://img.shields.io/badge/Tests-2545%2B%20Passing-22c55e)
...
> **Current system state:** v3.8.0 · Phase 13 complete (Market Signal Integrity) · Constitution v0.7.0 · 2545+ tests passing
...
**New in this release:** Phase 13 complete — Market Signal Integrity Invariant (Track 11-B). Constitution v0.7.0 `market_signal_integrity_invariant` BLOCKING rule; `consecutive_synthetic_epochs` counter on `IntegrationResult`; `EpochResult.consecutive_synthetic_market_epochs`; 35 new tests.
...
- [Constitution](CONSTITUTION.md) — hard constraints and tier definitions (v0.7.0)
...
|---|---|
| **Version** | 3.8.0 |
| **Active phase** | Phase 13 — Market Signal Integrity (complete) |
...
As of v3.8.0 it runs a **13-phase governance-gated sequence** per epoch:
...
**Constitution v0.7.0 BLOCKING rules:**
...
ADAAD is organized into seven layers as of v3.8.0:
...
| [**Constitution**](CONSTITUTION.md) | Hard governance constraints; v0.7.0 with 18 BLOCKING rules |
...
*Last reviewed: 2026-03-09 · Version: 3.8.0 · Phase 13 complete · Auto-versioned via `governance/report_version.json`*
