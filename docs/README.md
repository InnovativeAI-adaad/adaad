...
![Version: 3.9.0](https://img.shields.io/badge/Version-3.9.0-2ea043)
![Phase: 14 Complete](https://img.shields.io/badge/Phase-14%20Complete-6366f1)
![Tests: 2564+ Passing](https://img.shields.io/badge/Tests-2564%2B%20Passing-22c55e)
...
> **Current system state:** v3.9.0 · Phase 14 complete (ProposalEngine Activation) · Constitution v0.7.0 · 2564+ tests passing
...
**New in this release:** Phase 14 complete — ProposalEngine activation. `_proposal_to_candidate()` bridge + Phase 1e wiring in `EvolutionLoop`. Live signal context population. 33 new tests.
...
|---|---|
| **Version** | 3.9.0 |
| **Active phase** | Phase 14 — ProposalEngine Activation (complete) |
...
As of v3.9.0 it runs a **14-phase governance-gated sequence** per epoch:
...
ADAAD is organized into seven layers as of v3.9.0:
...
*Last reviewed: 2026-03-09 · Version: 3.9.0 · Phase 14 complete · Auto-versioned via `governance/report_version.json`*
