...
![Version: 5.8.0](https://img.shields.io/badge/Version-5.8.0-2ea043)
![Phase: 33 Complete](https://img.shields.io/badge/Phase-33%20Complete-6366f1)
![Tests: 767+ Passing](https://img.shields.io/badge/Tests-767%2B%20Passing-22c55e)
...
> **Current system state:** v5.8.0 · Phase 33 complete (Certifier Scan Ledger & Rejection Rate Health Signal) · Constitution v0.7.0 · 767+ tests passing
...
**New in this release:** v5.8.0 — Phase 33 complete. CertifierScanLedger (SHA-256 hash-chained JSONL audit ledger for GateCertifier scan results) + `certifier_rejection_rate_score` as 8th governance health signal (weight 0.07). 38 new tests, 767 total. All 8 `SIGNAL_WEIGHTS` sum to 1.00.
...
|---|---|
| **Version** | 5.8.0 |
| **Active phase** | Phase 33 — Certifier Scan Ledger & Rejection Rate Health Signal (complete) |
