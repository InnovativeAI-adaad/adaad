...
![Version: 4.0.0](https://img.shields.io/badge/Version-4.0.0-2ea043)
![Phase: 15 Complete](https://img.shields.io/badge/Phase-15%20Complete-6366f1)
![Tests: 2587+ Passing](https://img.shields.io/badge/Tests-2587%2B%20Passing-22c55e)
...
> **Current system state:** v4.0.0 · Phase 15 complete (Governance Intelligence Loop) · Constitution v0.7.0 · 2587+ tests passing
...
**New in this release:** v4.0.0 — autonomous governance intelligence loop complete. GovernanceDebtLedger + lineage_health fully wired. 23 new tests.
...
|---|---|
| **Version** | 4.0.0 |
| **Active phase** | Phase 15 — Governance Intelligence Loop (complete) |
