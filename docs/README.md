...
![Version: 3.5.0](https://img.shields.io/badge/Version-3.5.0-2ea043)
![Phase: 10 Complete](https://img.shields.io/badge/Phase-10%20Complete-6366f1)
![Tests: 2409+ Passing](https://img.shields.io/badge/Tests-2409%2B%20Passing-22c55e)
![Governance: Fail-Closed](https://img.shields.io/badge/Governance-Fail--Closed-dc2626)
![Constitution: v0.5.0](https://img.shields.io/badge/Constitution-v0.5.0-0ea5e9)
...
> **Current system state:** v3.5.0 · Phase 10 complete (Reward Learning Pipeline) · Constitution v0.5.0 · 2409+ tests passing
...
- [Constitution](CONSTITUTION.md) — hard constraints and tier definitions (v0.5.0)
...
|---|---|
| **Version** | 3.5.0 |
| **Active phase** | Phase 10 — Reward Learning Pipeline (complete) |
| **Constitution** | v0.5.0 (`soulbound_privacy_invariant` BLOCKING rule active) |
...
As of v3.5.0 it runs a **10-phase governance-gated sequence** per epoch:
...
**Constitution v0.5.0 BLOCKING rules:**
...
ADAAD is organized into seven layers as of v3.5.0:
...
| [**Constitution**](CONSTITUTION.md) | Hard governance constraints; v0.5.0 with `soulbound_privacy_invariant` |
...
| [CHANGELOG](../CHANGELOG.md) | Full version history; v3.5.0 is current |
...
*Last reviewed: 2026-03-09 · Version: 3.5.0 · Phase 10 complete · Auto-versioned via `governance/report_version.json`*
